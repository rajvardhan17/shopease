...
public class OrderServlet extends HttpServlet {
    ...
    private void setCorsHeaders(HttpServletRequest request, HttpServletResponse response) {
        String[] allowedOrigins = {"http://localhost:3000","https://shopease-six-navy.vercel.app", "http://localhost:8080","https://shopease-6p3wxf3cu-rajvardhan-singh-dewdas-projects.vercel.app"};
