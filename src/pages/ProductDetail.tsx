...
const allProducts = {
  tshirts: [
    { id: "1", name: "Classic Cotton T-Shirt", price: 899, category: "tshirt" },
    { id: "2", name: "Premium Polo Shirt", price: 1299, category: "tshirt" },
    { id: "3", name: "Graphic Print Tee", price: 1099, category: "tshirt" },
    { id: "4", name: "V-Neck Basic Tee", price: 799, category: "tshirt" },
  ],
  shoes: [
    { id: "5", name: "Running Sneakers", price: 2999, category: "shoe" },
    { id: "6", name: "Casual Loafers", price: 2499, category: "shoe" },
    { id: "7", name: "Sport Sandals", price: 1899, category: "shoe" },
    { id: "8", name: "Canvas Shoes", price: 1599, category: "shoe" },
  ],
  shirts: [
    { id: "9", name: "Formal White Shirt", price: 1599, category: "shirt" },
    { id: "10", name: "Casual Check Shirt", price: 1399, category: "shirt" },
    { id: "11", name: "Denim Shirt", price: 1899, category: "shirt" },
    { id: "12", name: "Linen Summer Shirt", price: 1699, category: "shirt" },
  ],
  accessories: [
    { id: "13", name: "Leather Belt", price: 999, category: "accessory" },
    { id: "14", name: "Classic Watch", price: 4999, category: "accessory" },
    { id: "15", name: "Leather Wallet", price: 1299, category: "accessory" },
    { id: "16", name: "Sunglasses", price: 1899, category: "accessory" },
  ]
};
